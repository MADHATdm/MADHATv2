...
Please note: The version of madhat2.py currently present on this repository contains an issue: "filepath" should be replaced with "filename" for the first five instances of the former. A corrected version of the code has been made offline and will hopefully be uploaded by the end of October 13, 2023. I apologize for any inconvenience!
