...
PLEASE NOTE: The current "nobs" files within PMFdata seem to have incorrect values for the exposures at the moment, which should negatively affect calulcations. This should hopefully be fixed before the end of December 23rd. I sincerely apologize for the inconvenience! MADHAT v2 places bounds on the dark matter annihilation cross section through a Fermi-LAT-data-based, model-independent analysis of dark matter annihilation into gamma rays within dwarf galaxies/dwarf-like objects. The tool features improved sensitivity to dark matter models relative to version 1.0 via photon weighting by dwarf galaxy of origin and energy.
